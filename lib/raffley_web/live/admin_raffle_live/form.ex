defmodule RaffleyWeb.AdminRaffleLive.Form do
  ...
  def render(assigns) do
    ...
    <.simple_form for={@form} id="raffle-form" phx-submit="save" phx-change="validate">
      ...
      <.input field={@form[:description]} type="textarea" label="Description" phx-debounce="blur" required />
  ...
  def handle_event("validate", %{"raffle" => raffle}, socket) do
    changeset = Admin.change_raffle(socket.assigns.raffle, raffle)
